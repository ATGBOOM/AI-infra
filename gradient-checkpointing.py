...
#Doesn't store all the computations during forward pas to recom[putes during
#the backward pass. May increase comp time but reduces memory usage significant. Stores
#computation every few layers
...
if __name__ == "__main__":
    ...
    # Save to JSON
    save_metrics(metrics, config, "benchmarks/gradient-checkpoint.json")