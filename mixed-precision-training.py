...
# Tensor cores are better at computing fb16 bits so it provides those with a mix of
# 32 bit to avoid tradeoff of gradient becoming too small
# This will increase speed of computation
...
def train_and_benchmark(model, dataloader, gpu_handle, scaler, batch_size=BATCH_SIZE, seq_len=SEQ_LEN, num_steps=STEPS, use_mixed_precision=False):
